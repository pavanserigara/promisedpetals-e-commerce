...
<div class="bg-gray-100 min-h-screen">
    <div class="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded-lg px-8 py-6">
            ...
            <form action="<?php echo URLROOT; ?>/admin/edit_category/<?php echo $data['category']->id; ?>" method="POST"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea id="description" name="description" rows="3"
                                class="shadow-sm focus:ring-brand-500 focus:border-brand-500 block w-full sm:text-sm border border-gray-300 rounded-md p-2"><?php echo isset($data['category']->description) ? $data['category']->description : ''; ?></textarea>
                        </div>
                    </div>

                    <!-- Current Image -->
                    <?php if (isset($data['category']->image) && $data['category']->image): ?>
                        <div>
