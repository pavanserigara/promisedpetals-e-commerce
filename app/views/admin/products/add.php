    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="bg-white border-b border-brand-100 py-6 px-8">
                <h1 class="text-2xl font-serif font-bold text-slate-800">Add New Bloom</h1>
                <p class="text-slate-500 mt-1 text-sm">Fill in the details to add a new item to your boutique catalog.
                </p>
            </div>
            ...
            <form action="<?php echo URLROOT; ?>/admin/add_product" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <input type="text" name="name" id="name" required placeholder="e.g. Red Velvet Rose Bouquet"
                    ...
                    <div>
                        ...
                        <input type="number" name="stock" id="stock" value="100"
                            class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-brand-500 focus:border-brand-500 sm:text-sm transition">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <textarea id="description" name="description" rows="4"
                            class="shadow-sm focus:ring-brand-500 focus:border-brand-500 block w-full sm:text-sm border border-gray-300 rounded-lg p-3 transition"
                            placeholder="Describe the arrangements, flowers used, and emotions conveyed..."></textarea>
                    </div>
                    <p class="mt-2 text-xs text-gray-500">Write a compelling description to attract customers.</p>
                </div>
                ...
                <div>
                    ...
                    <div
                        class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-brand-100 border-dashed rounded-xl hover:border-brand-400 hover:bg-brand-50/30 transition-all group cursor-pointer relative">
